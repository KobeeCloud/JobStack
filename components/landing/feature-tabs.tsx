          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="p-6 border-b md:border-b-0 md:border-r border-border/40 flex flex-col gap-4 justify-center">
                <span
                  className={`inline-flex w-fit text-[10px] px-2 py-0.5 rounded border font-mono font-bold ${tab.badgeColor}`}
                >
                  {tab.badge}
                </span>
                <div>
              ...
              <div className="bg-zinc-950 dark:bg-zinc-900/80 flex flex-col overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-4 py-2 border-b border-zinc-800 dark:border-zinc-700">
                  ...
                  <span
                    className={`ml-auto text-[9px] px-1.5 py-0.5 rounded border font-mono ${tab.badgeColor}`}
                  >
                    {tab.badge}
                  </span>
                </div>
