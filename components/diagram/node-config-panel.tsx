...
export function NodeConfigPanel() {
      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm">
              {String(node.data?.label || componentId || '')}
            </span>
          </div>
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1">
          <div className="flex items-center gap-2 text-amber-600 dark:text-amber-400 text-xs bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-md p-2">
            ...
            <span>
              Component type <code className="font-mono">{String(componentId ?? '')}</code> not
              found in catalog. Basic editing only.
            </span>
          </div>
        ...
        <div className="p-4 border-t flex gap-2">
          <Button
            ...
            onClick={() => {
              setNodes(nds =>
                nds.map(n => (n.id === node.id ? { ...n, data: { ...n.data, config } } : n))
              )
          ...
          <Button size="sm" variant="outline" onClick={() => setConfigPanelOpen(false)}>
            Cancel
          </Button>
        </div>
      </div>
      ...
      <>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            min={30}
            max={4096}
            value={config.diskSize || 128}
            onChange={e => updateConfig('diskSize', parseInt(e.target.value))}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select
            value={config.diskType || 'premium_ssd'}
            onValueChange={v => updateConfig('diskType', v)}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <div className="flex items-center space-x-2">
          <input
            type="checkbox"
            id="publicIp"
            checked={config.publicIp || false}
            onChange={e => updateConfig('publicIp', e.target.checked)}
            className="w-4 h-4"
          />
        ...
        {provider === 'azure' && (
          <>
            <div className="space-y-2">
              ...
              <Select
                value={config.availability_zone || '__none__'}
                onValueChange={v =>
                  updateConfig('availability_zone', v === '__none__' ? undefined : v)
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={config.ssh_key_data || ''}
                onChange={e => updateConfig('ssh_key_data', e.target.value)}
              />
              <p className="text-xs text-muted-foreground">
                Paste your public key or leave blank to use file(&quot;~/.ssh/id_rsa.pub&quot;)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.os_disk_type || 'Premium_LRS'}
                onValueChange={v => updateConfig('os_disk_type', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                min={30}
                max={4096}
                value={config.os_disk_size_gb || 64}
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.identity_type || '__none__'}
                onValueChange={v => updateConfig('identity_type', v === '__none__' ? undefined : v)}
              >
                <SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="bootDiag"
                checked={config.boot_diagnostics_enabled || false}
                onChange={e => updateConfig('boot_diagnostics_enabled', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="bootDiag" className="font-normal">
        ...
        {provider === 'aws' && (
          <>
            <div className="space-y-2">
              ...
              >
                <SelectTrigger>
                  <SelectValue placeholder="No preference (auto-place)" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="__none__">No preference</SelectItem>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Leave blank to use latest for selected OS/region
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.instance_market_type || 'on_demand'}
                onValueChange={v => updateConfig('instance_market_type', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="awsTermProt"
                checked={config.disable_api_termination || false}
                onChange={e => updateConfig('disable_api_termination', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="awsTermProt" className="font-normal">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={e => updateConfig('monitoring', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="awsMonitoring" className="font-normal">
                Detailed Monitoring (CloudWatch 1-min)
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                ...
                className="w-4 h-4"
              />
              <Label htmlFor="awsEbsOpt" className="font-normal">
                EBS Optimized
              </Label>
            </div>
          </>
        ...
        {provider === 'gcp' && (
          <>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.boot_disk_type || 'pd-balanced'}
                onValueChange={v => updateConfig('boot_disk_type', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="#!/bin/bash"
                value={config.metadata_startup_script || ''}
            ...
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="gcpSpot"
                checked={config.preemptible || false}
                onChange={e => {
                  updateConfig('preemptible', e.target.checked)
                  updateConfig('provisioning_model', e.target.checked ? 'SPOT' : 'STANDARD')
                }}
                className="w-4 h-4"
              />
              <Label htmlFor="gcpSpot" className="font-normal">
                Spot VM (Preemptible — up to 91% savings)
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="gcpDelProt"
                checked={config.deletion_protection || false}
                onChange={e => updateConfig('deletion_protection', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="gcpDelProt" className="font-normal">
                Deletion Protection
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="gcpShielded"
                checked={config.enable_shielded_vm || false}
                onChange={e => updateConfig('enable_shielded_vm', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="gcpShielded" className="font-normal">
  ...
  const renderNetworkingConfig = () => {
    ...
    if (componentInfo && (id.includes('vnet') || id.includes('vpc'))) {
      return (
        <>
          <div className="space-y-2">
            <Label>
              {provider === 'aws' ? 'CIDR Block' : 'Address Space (CIDR, comma-separated)'}
            </Label>
            <Input
              placeholder="10.0.0.0/16"
              value={
                Array.isArray(config.address_space)
                  ? config.address_space.join(', ')
                  : config.cidr_block || config.addressSpace || ''
              }
              onChange={e => {
          ...
          {provider === 'azure' && (
            <>
              <div className="space-y-2">
                ...
                <Input
                  placeholder="168.63.129.16"
                  value={
                    Array.isArray(config.dns_servers)
                  ...
                  onChange={e => {
                    const v = e.target.value
                      ...
                      .map((s: string) => s.trim())
                      .filter(Boolean)
                    updateConfig('dns_servers', v)
                    updateConfig('dnsServers', v)
                  }}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  placeholder="12076:20010"
                  value={config.bgp_community || ''}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min={4}
                  max={30}
                  value={config.flow_timeout_in_minutes || 4}
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={e => updateConfig('ddos_protection_enabled', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="ddosEnabled" className="font-normal">
              ...
              {config.ddos_protection_enabled && (
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="/subscriptions/.../ddosProtectionPlans/..."
                    value={config.ddos_protection_plan_id || ''}
                    onChange={e =>
                      updateConfig('ddos_protection_plan_id', e.target.value || undefined)
                    }
                  />
                </div>
              )}
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="vmProtect"
                  checked={config.vm_protection_enabled || false}
                  onChange={e => updateConfig('vm_protection_enabled', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="vmProtect" className="font-normal">
            ...
            <>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="vpcDnsH"
                  checked={config.enable_dns_hostnames !== false}
                  onChange={e => updateConfig('enable_dns_hostnames', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="vpcDnsH" className="font-normal">
                  Enable DNS Hostnames (required for EKS/RDS)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="vpcDnsS"
                  checked={config.enable_dns_support !== false}
                  onChange={e => updateConfig('enable_dns_support', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="vpcDnsS" className="font-normal">
                  Enable DNS Support
                </Label>
              </div>
              <div className="space-y-2">
                ...
                <Select
                  value={config.instance_tenancy || 'default'}
                  onValueChange={v => updateConfig('instance_tenancy', v)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="vpcIpv6"
                  checked={config.assign_generated_ipv6_cidr_block || false}
                  onChange={e => updateConfig('assign_generated_ipv6_cidr_block', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="vpcIpv6" className="font-normal">
            ...
            <>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="gcpAutoSub"
                  checked={config.auto_create_subnetworks || false}
                  onChange={e => updateConfig('auto_create_subnetworks', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="gcpAutoSub" className="font-normal">
                  Auto Create Subnetworks (NOT for prod)
                </Label>
              </div>
              <div className="space-y-2">
                <Label>Routing Mode</Label>
                <Select
                  value={config.routing_mode || 'REGIONAL'}
                  onValueChange={v => updateConfig('routing_mode', v)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                <Label>MTU</Label>
                <Select
                  value={String(config.mtu || 1460)}
                  onValueChange={v => updateConfig('mtu', parseInt(v))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="gcpDelDef"
                  checked={config.delete_default_routes_on_create || false}
                  onChange={e => updateConfig('delete_default_routes_on_create', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="gcpDelDef" className="font-normal">
        ...
        <>
          <div className="space-y-2">
            ...
            <Input
              ...
              value={
                Array.isArray(config.address_prefixes)
                  ? config.address_prefixes.join(', ')
                  : config.cidr_block || config.addressPrefix || ''
              }
              onChange={e => {
                const val = e.target.value
                  .split(',')
              ...
              return (
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-1 max-h-40 overflow-y-auto border rounded p-2">
                      {SERVICE_ENDPOINTS.map(ep => {
                        const current: string[] = Array.isArray(config.service_endpoints)
                        ...
                        return (
                          <div key={ep} className="flex items-center space-x-2">
                            ...
                            />
                            <Label htmlFor={`ep-${ep}`} className="font-normal text-xs">
                              {ep}
                            </Label>
                          </div>
                        )
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={config.private_endpoint_network_policies ?? 'Disabled'}
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-4 h-4"
                    />
                    <Label htmlFor="plsNetPolicies" className="font-normal">
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      onChange={e =>
                        updateConfig('default_outbound_access_enabled', e.target.checked)
                      }
                      className="w-4 h-4"
                    />
                    <Label htmlFor="defaultOutbound" className="font-normal">
          ...
          {provider === 'aws' && (
            <>
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Any (AWS selects)" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4"
                />
                <Label htmlFor="mapPublicIp" className="font-normal">
                  Map Public IP on Launch (public subnet)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="subnetIpv6"
                  checked={config.assign_ipv6_address_on_creation || false}
                  onChange={e => updateConfig('assign_ipv6_address_on_creation', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="subnetIpv6" className="font-normal">
              ...
              <div className="space-y-2">
                ...
                <Input
                  placeholder="ipv4pool-coip-..."
                  value={config.customer_owned_ipv4_pool || ''}
                  onChange={e =>
                    updateConfig('customer_owned_ipv4_pool', e.target.value || undefined)
                  }
                />
              </div>
            </>
          ...
          {provider === 'gcp' && (
            <>
              ...
              <div className="space-y-2">
                <Label>Purpose</Label>
                <Select
                  value={config.purpose || 'PRIVATE'}
                  onValueChange={v => updateConfig('purpose', v)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    ...
                    <SelectItem value="REGIONAL_MANAGED_PROXY">
                      Regional Managed Proxy (L7 LB)
                    </SelectItem>
                    <SelectItem value="GLOBAL_MANAGED_PROXY">Global Managed Proxy</SelectItem>
                    <SelectItem value="INTERNAL_HTTPS_LOAD_BALANCER">
                      Internal HTTPS LB (legacy)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="gcpPrivGoogleAccess"
                  checked={config.private_ip_google_access || false}
                  onChange={e => updateConfig('private_ip_google_access', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="gcpPrivGoogleAccess" className="font-normal">
                  Private Google Access (VMs without public IP can reach Google APIs)
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="gcpFlowLogs"
                  checked={config.log_config_enable || false}
                  onChange={e => updateConfig('log_config_enable', e.target.checked)}
                  className="w-4 h-4"
                />
                <Label htmlFor="gcpFlowLogs" className="font-normal">
              ...
              {config.log_config_enable && (
                <div className="space-y-2">
                  ...
                  <Select
                    value={config.log_config_aggregation_interval || 'INTERVAL_5_SEC'}
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.private_ip_address_allocation || 'Dynamic'}
              onValueChange={v => updateConfig('private_ip_address_allocation', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          {config.private_ip_address_allocation === 'Static' && (
            <div className="space-y-2">
              ...
              <Input
                ...
                value={config.private_ip_address || ''}
                onChange={e => updateConfig('private_ip_address', e.target.value)}
              />
            </div>
          )}
          <div className="space-y-2">
            ...
            <Select
              value={config.private_ip_address_version || 'IPv4'}
              onValueChange={v => updateConfig('private_ip_address_version', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="nicAccNet"
              checked={config.accelerated_networking_enabled || false}
              onChange={e => updateConfig('accelerated_networking_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="nicAccNet" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="nicIpFwd"
              checked={config.ip_forwarding_enabled || false}
              onChange={e => updateConfig('ip_forwarding_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="nicIpFwd" className="font-normal">
                ...
                <div key={i} className="border rounded p-2 space-y-1.5 text-xs">
                  <div className="flex gap-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        const rules = (config.security_rules || []).filter(
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.allocation_method || 'Static'}
              onValueChange={v => updateConfig('allocation_method', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.sku_tier || 'Regional'}
              onValueChange={v => updateConfig('sku_tier', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>IP Version</Label>
            <Select
              value={config.ip_version || 'IPv4'}
              onValueChange={v => updateConfig('ip_version', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.zones || 'zone-redundant'}
              onValueChange={v => {
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={4}
              max={30}
              value={config.idle_timeout_in_minutes || 4}
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="my-app"
              value={config.domain_name_label || ''}
              onChange={e => updateConfig('domain_name_label', e.target.value || undefined)}
            />
            <p className="text-xs text-muted-foreground">
              Results in: &lt;label&gt;.&lt;region&gt;.cloudapp.azure.com
            </p>
          </div>
          <div className="space-y-2">
            <Label>DDoS Protection Mode</Label>
            <Select
              value={config.ddos_protection_mode || 'VirtualNetworkInherited'}
              onValueChange={v => updateConfig('ddos_protection_mode', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="disableBgp"
              checked={config.disable_bgp_route_propagation || false}
              onChange={e => updateConfig('disable_bgp_route_propagation', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="disableBgp" className="font-normal">
          ...
          <div className="space-y-2">
            ...
            {(config.routes || []).map((route: any, i: number) => (
              <div key={i} className="border rounded p-2 space-y-1.5">
                ...
                <Input
                  className="h-7 text-xs"
                  placeholder="address prefix: 0.0.0.0/0"
                  value={route.address_prefix || ''}
                  onChange={e => {
                    const routes = [...(config.routes || [])]
                ...
                />
                <Select
                  value={route.next_hop_type || 'VnetLocal'}
                  onValueChange={v => {
                    const routes = [...(config.routes || [])]
                ...
                {route.next_hop_type === 'VirtualAppliance' && (
                  <Input
                    className="h-7 text-xs"
                    placeholder="next hop IP: 10.0.2.4"
                    value={route.next_hop_in_ip_address || ''}
                    onChange={e => {
                      const routes = [...(config.routes || [])]
            ...
            <Button
              ...
              onClick={() => {
                const routes = [
                  ...(config.routes || []),
                  {
                    name: `route-${(config.routes || []).length + 1}`,
      ...
      return (
        <>
          <div className="space-y-2">
            <Label>SKU</Label>
            <Select
              value={config.sku_name || 'Standard'}
              onValueChange={v => updateConfig('sku_name', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>Availability Zone</Label>
            <Select
              value={config.zone || '__none__'}
              onValueChange={v => updateConfig('zone', v === '__none__' ? undefined : v)}
            >
              <SelectTrigger>
                <SelectValue placeholder="No preference" />
              </SelectTrigger>
    ...
    if (
      componentInfo &&
      (componentInfo.id.includes('lb') || componentInfo.id.includes('load-balancer'))
    ) {
      return (
        <>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.frontend_ip_allocation || 'Dynamic'}
              onValueChange={v => updateConfig('frontend_ip_allocation', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.frontend_ip_type || 'public'}
              onValueChange={v => updateConfig('frontend_ip_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.sku_name || 'Standard_v2'}
              onValueChange={v => updateConfig('sku_name', v)}
            >
              <SelectTrigger>
                <SelectValue />
            ...
            <>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min={0}
                  max={100}
                  value={config.autoscale_min_capacity ?? 1}
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min={1}
                  max={125}
                  value={config.autoscale_max_capacity ?? 10}
          ...
          {config.sku_name === 'WAF_v2' && (
            <>
              <div className="space-y-2">
                ...
                <Select
                  value={config.waf_mode || 'Detection'}
                  onValueChange={v => updateConfig('waf_mode', v)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={config.waf_rule_set_version || '3.2'}
                  onValueChange={v => updateConfig('waf_rule_set_version', v)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>Zones</Label>
            <Select
              value={config._zones_ui || 'zone-redundant'}
              onValueChange={v => {
                const map: Record<string, string[]> = {
                  'zone-redundant': ['1', '2', '3'],
                  '1': ['1'],
      ...
      return (
        <>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.kubernetes_version || '1.31'}
              onValueChange={v => updateConfig('kubernetes_version', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={config.default_node_pool_vm_size || 'Standard_D2s_v3'}
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config._node_zones_ui || 'zone-redundant'}
              onValueChange={v => {
                const map: Record<string, string[]> = {
                  'zone-redundant': ['1', '2', '3'],
                  '1': ['1'],
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={30}
              max={2048}
              value={config.os_disk_size_gb || 128}
              onChange={e => updateConfig('os_disk_size_gb', parseInt(e.target.value))}
            />
          </div>
          <div className="space-y-2">
            ...
            <Select
              value={config.network_plugin || 'azure'}
              onValueChange={v => updateConfig('network_plugin', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.network_policy || 'azure'}
              onValueChange={v => updateConfig('network_policy', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.identity_type || 'SystemAssigned'}
              onValueChange={v => updateConfig('identity_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="oidcIssuer"
              checked={config.oidc_issuer_enabled || false}
              onChange={e => updateConfig('oidc_issuer_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="oidcIssuer" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="workloadIdentity"
              checked={config.workload_identity_enabled || false}
              onChange={e => updateConfig('workload_identity_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="workloadIdentity" className="font-normal">
          ...
          {rules.map((r, i) => (
            <div key={i} className="border rounded p-2 space-y-1 text-xs">
              <div className="flex gap-1">
                <Select
                  value={r.protocol}
                  onValueChange={v => updateRule(direction, i, 'protocol', v)}
                >
                ...
                <Input
                  ...
                  value={r.from_port}
                  onChange={e =>
                    updateRule(direction, i, 'from_port', parseInt(e.target.value) || 0)
                  }
                />
                <Input
                  className="h-7 w-16"
              ...
              <div className="flex gap-1">
                ...
                />
                <button
                  onClick={() => removeRule(direction, i)}
        ...
        <>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="sgRevoke"
              checked={config.revoke_rules_on_delete || false}
              onChange={e => updateConfig('revoke_rules_on_delete', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="sgRevoke" className="font-normal">
              Revoke rules before delete (avoid cyclic dependency)
            </Label>
          </div>
        </>
      )
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.direction || 'INGRESS'}
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="tcp:22,tcp:443,icmp"
              value={config.allow_ports || ''}
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="web-tier, app-tier"
              value={
                Array.isArray(config.target_tags)
                  ? config.target_tags.join(', ')
                  : config.target_tags || ''
              }
              onChange={e =>
                updateConfig(
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={
                Array.isArray(config.source_tags)
                  ? config.source_tags.join(', ')
                  : config.source_tags || ''
              }
              onChange={e =>
                updateConfig(
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="gcpFwDisabled" className="font-normal">
              Disabled (soft-disabled without deleting)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="gcpFwLog" className="font-normal">
      ...
      return (
        <>
          <div className="space-y-2">
            <Label>Scheme</Label>
            <Select
              value={config.internal ? 'internal' : 'internet-facing'}
              onValueChange={v => updateConfig('internal', v === 'internal')}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.load_balancer_type || (isNlb ? 'network' : 'application')}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => updateConfig('ip_address_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="dualstack-without-public-ipv4">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="lbDelProt" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="lbHttp2" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="lbAccessLogs"
              checked={config.access_logs_enabled || false}
              onChange={e => updateConfig('access_logs_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="lbAccessLogs" className="font-normal">
          ...
          {config.access_logs_enabled && (
            <div className="space-y-2">
              ...
              <Input
                placeholder="my-alb-logs-bucket"
                value={config.access_logs_bucket || ''}
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.load_balancing_scheme || 'EXTERNAL_MANAGED'}
              onValueChange={v => updateConfig('load_balancing_scheme', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="INTERNAL_SELF_MANAGED">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => updateConfig('protocol', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={e => updateConfig('enable_cdn', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="gcpCdn" className="font-normal">
              Enable Cloud CDN
            </Label>
          </div>
          {config.enable_cdn && (
            <div className="space-y-2">
              ...
              <Select
                value={config.cdn_cache_mode || 'CACHE_ALL_STATIC'}
                onValueChange={v => updateConfig('cdn_cache_mode', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="gcpLbLog" className="font-normal">
              Enable Logging
            </Label>
          </div>
        </>
      ...
      return (
        <>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.sse_algorithm || 'AES256'}
              onValueChange={v => updateConfig('sse_algorithm', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="s3Version" className="font-normal">
              Enable Versioning
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="s3BlockAll"
              checked={config.block_public_acls !== false}
              onChange={e => updateConfig('block_public_acls', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="s3BlockAll" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="s3WebHosting"
              checked={config.static_website_hosting || false}
              onChange={e => updateConfig('static_website_hosting', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="s3WebHosting" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="s3ForceDestroy"
              checked={config.force_destroy || false}
              onChange={e => updateConfig('force_destroy', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="s3ForceDestroy" className="font-normal">
              Force Destroy (delete non-empty bucket)
            </Label>
          </div>
        </>
      )
        ...
        <>
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => updateConfig('location', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => updateConfig('storage_class', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="gcsVersioning" className="font-normal">
              Enable Versioning
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="gcsUniform"
              checked={config.uniform_bucket_level_access !== false}
              onChange={e => updateConfig('uniform_bucket_level_access', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="gcsUniform" className="font-normal">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="gcsForceDel" className="font-normal">
              Force Destroy (delete non-empty)
            </Label>
          </div>
          <div className="space-y-2">
            ...
            <Input
              type="number"
              min={0}
              value={config.retention_policy_days || 0}
              onChange={e =>
                updateConfig('retention_policy_days', parseInt(e.target.value) || undefined)
              }
            />
          </div>
        </>
        ...
        <>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="gcpDiskDel"
              checked={config.allow_stopping_for_update !== false}
              onChange={e => updateConfig('allow_stopping_for_update', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="gcpDiskDel" className="font-normal">
        ...
        <>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="ebsEncrypt" className="font-normal">
              Encrypted
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="ebsDeleteOnTerm"
              checked={config.delete_on_termination !== false}
              onChange={e => updateConfig('delete_on_termination', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="ebsDeleteOnTerm" className="font-normal">
        ...
        {componentInfo && id.includes('storage') && (
          <>
            <div className="space-y-2">
              ...
              <Select
                value={config.account_kind || 'StorageV2'}
                onValueChange={v => updateConfig('account_kind', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={v => updateConfig('accountTier', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={v => updateConfig('replicationType', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.access_tier || 'Hot'}
                onValueChange={v => updateConfig('access_tier', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={config.min_tls_version || 'TLS1_2'}
                onValueChange={v => updateConfig('min_tls_version', v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="blobHttps"
                checked={config.enable_https_traffic_only !== false}
                onChange={e => updateConfig('enable_https_traffic_only', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="blobHttps" className="font-normal">
                HTTPS Traffic Only
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="blobSoftDelete"
                checked={config.blob_soft_delete_enabled || false}
                onChange={e => updateConfig('blob_soft_delete_enabled', e.target.checked)}
                className="w-4 h-4"
              />
              <Label htmlFor="blobSoftDelete" className="font-normal">
                Blob Soft Delete
              </Label>
            </div>
            {config.blob_soft_delete_enabled && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  min={1}
                  max={365}
                  value={config.blob_soft_delete_days || 7}
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select value={config.engine || 'mysql'} onValueChange={v => updateConfig('engine', v)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="aurora-postgresql">
                  Aurora PostgreSQL (Serverless-capable)
                </SelectItem>
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="8.0.35 / 15.5 / 3.04.1"
              value={config.engine_version || ''}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => updateConfig('instance_class', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.storage_type || 'gp3'}
              onValueChange={v => updateConfig('storage_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={e => updateConfig('multi_az', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="rdsMultiAZ" className="font-normal">
              Multi-AZ Deployment (HA with standby)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="rdsEncrypt"
              checked={config.storage_encrypted !== false}
              onChange={e => updateConfig('storage_encrypted', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="rdsEncrypt" className="font-normal">
              Storage Encrypted
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={e => updateConfig('publicly_accessible', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="rdsPublic" className="font-normal">
              Publicly Accessible
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="rdsDeletionProt" className="font-normal">
              Deletion Protection
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="rdsAutoUpgrade"
              checked={config.auto_minor_version_upgrade !== false}
              onChange={e => updateConfig('auto_minor_version_upgrade', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="rdsAutoUpgrade" className="font-normal">
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.database_version || 'POSTGRES_15'}
              onValueChange={v => updateConfig('database_version', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="SQLSERVER_2022_ENTERPRISE">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.tier || 'db-f1-micro'}
              onValueChange={v => updateConfig('tier', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.availability_type || 'ZONAL'}
              onValueChange={v => updateConfig('availability_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>Disk Type</Label>
            <Select
              value={config.disk_type || 'PD_SSD'}
              onValueChange={v => updateConfig('disk_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="csqlAutoResize"
              checked={config.disk_autoresize !== false}
              onChange={e => updateConfig('disk_autoresize', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="csqlAutoResize" className="font-normal">
              Disk Auto-Resize
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="csqlBackup"
              checked={config.backup_configuration_enabled !== false}
              onChange={e => updateConfig('backup_configuration_enabled', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="csqlBackup" className="font-normal">
              Automated Backups
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-4 h-4"
            />
            <Label htmlFor="csqlDelProt" className="font-normal">
              Deletion Protection
            </Label>
          </div>
        </>
      ...
      <>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            min={1}
            max={35}
            value={config.backupRetentionDays || 7}
        ...
        <div className="flex items-center space-x-2">
          <input
            type="checkbox"
            id="sqlZoneRedundant"
            checked={config.zone_redundant || false}
            onChange={e => updateConfig('zone_redundant', e.target.checked)}
            className="w-4 h-4"
          />
          <Label htmlFor="sqlZoneRedundant" className="font-normal">
            Zone Redundant (Premium/Business Critical only)
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <input
            type="checkbox"
            id="sqlReadScale"
            checked={config.read_scale || false}
            onChange={e => updateConfig('read_scale', e.target.checked)}
            className="w-4 h-4"
          />
          <Label htmlFor="sqlReadScale" className="font-normal">
            Read Scale-Out (Premium/BC only)
          </Label>
        </div>
        <div className="flex items-center space-x-2">
          <input
            type="checkbox"
            id="sqlGeoBackup"
            checked={config.geo_backup_enabled !== false}
            onChange={e => updateConfig('geo_backup_enabled', e.target.checked)}
            className="w-4 h-4"
          />
          <Label htmlFor="sqlGeoBackup" className="font-normal">
      ...
      return (
        <>
          <div className="space-y-2">
            <Label>Runtime</Label>
            <Select
              value={config.runtime || 'nodejs20.x'}
              onValueChange={v => updateConfig('runtime', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={String(config.memory_size || 128)}
              onValueChange={v => updateConfig('memory_size', parseInt(v))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.architectures || 'x86_64'}
              onValueChange={v => updateConfig('architectures', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              type="number"
              min={-1}
              value={config.reserved_concurrent_executions ?? -1}
              onChange={e =>
                updateConfig('reserved_concurrent_executions', parseInt(e.target.value))
              }
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              min={512}
              max={10240}
              value={config.ephemeral_storage_size || 512}
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="lambdaSnapStart"
              checked={config.snap_start || false}
              onChange={e => updateConfig('snap_start', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="lambdaSnapStart" className="font-normal">
              SnapStart (Java only — fast cold starts)
            </Label>
          </div>
        </>
      )
      ...
      return (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={config.launch_type || 'FARGATE'}
              onValueChange={v => updateConfig('launch_type', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={String(config.task_cpu || 256)}
              onValueChange={v => updateConfig('task_cpu', parseInt(v))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={String(config.task_memory || 512)}
              onValueChange={v => updateConfig('task_memory', parseInt(v))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.network_mode || 'awsvpc'}
              onValueChange={v => updateConfig('network_mode', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="ecsCapSpot"
              checked={config.capacity_provider === 'FARGATE_SPOT'}
              onChange={e =>
                updateConfig('capacity_provider', e.target.checked ? 'FARGATE_SPOT' : 'FARGATE')
              }
              className="w-4 h-4"
            />
            <Label htmlFor="ecsCapSpot" className="font-normal">
              Use Fargate Spot (up to 70% cheaper, interruptible)
            </Label>
          </div>
        </>
      )
        ...
        <>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={0}
              max={1000}
              value={config.min_instance_count ?? 0}
              onChange={e => updateConfig('min_instance_count', parseInt(e.target.value))}
            />
            <p className="text-xs text-muted-foreground">
              Set &gt;0 to prevent cold starts (incurs cost)
            </p>
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              min={1}
              max={1000}
              value={config.max_instance_count || 100}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={1}
              max={1000}
              value={config.container_concurrency || 80}
          ...
          <div className="space-y-2">
            <Label>Ingress</Label>
            <Select
              value={config.ingress || 'INGRESS_TRAFFIC_ALL'}
              onValueChange={v => updateConfig('ingress', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="INGRESS_TRAFFIC_INTERNAL_LOAD_BALANCER">
                  Load Balancer only
                </SelectItem>
      ...
      return (
        <>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.available_memory || '256M'}
              onValueChange={v => updateConfig('available_memory', v)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={config.trigger_type || 'http'}
      ...
      <>
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={e => updateConfig('alwaysOn', e.target.checked)}
            className="w-4 h-4"
          />
    ...
    <>
          ...
          <div key={t} className="flex items-center gap-2">
            <input
              ...
              onChange={e => {
                ...
                updateConfig(
                  'triggers',
                  e.target.checked ? [...cur, t] : cur.filter((x: string) => x !== t)
                )
              }}
              className="w-4 h-4"
            />
            <Label htmlFor={`trigger-${t}`} className="font-normal capitalize">
              {t.replace(/_/g, ' ')}
            </Label>
          </div>
        ))}
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          value={(config.branches || ['main']).join(', ')}
          onChange={e =>
            updateConfig(
              'branches',
              e.target.value
      ...
      <div className="space-y-2">
        <Label>Runner</Label>
        <Select
          value={config.runsOn || 'ubuntu-latest'}
          onValueChange={v => updateConfig('runsOn', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={v => updateConfig('nodeVersion', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.deployTarget || 'kubernetes'}
          onValueChange={v => updateConfig('deployTarget', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
  ...
  const renderGitLabCIConfig = () => (
    <>
      <div className="space-y-2">
        ...
        <Input
          placeholder="main"
          value={(config.branches || ['main'])[0]}
          onChange={e =>
            updateConfig('branches', [e.target.value, ...(config.branches || ['main']).slice(1)])
          }
        />
      </div>
      <div className="space-y-2">
  ...
  const renderArgoCDConfig = () => (
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder="HEAD"
          value={config.targetRevision || 'HEAD'}
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder="default"
          value={config.destinationNamespace || 'default'}
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.syncPolicy || 'automated'}
          onValueChange={v => updateConfig('syncPolicy', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
        ...
        <>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="selfHeal"
              checked={config.selfHeal !== false}
              onChange={e => updateConfig('selfHeal', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="selfHeal" className="font-normal">
              Self-heal (auto-revert drift)
            </Label>
          </div>
          <div className="flex items-center space-x-2">
            <input
              type="checkbox"
              id="prune"
              checked={config.prune !== false}
              onChange={e => updateConfig('prune', e.target.checked)}
              className="w-4 h-4"
            />
            <Label htmlFor="prune" className="font-normal">
  ...
  const renderHelmConfig = () => (
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder="my-registry/my-app"
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.serviceType || 'ClusterIP'}
      ...
      <div className="flex items-center space-x-2">
        <input
          type="checkbox"
          id="ingressEnabled"
          checked={config.ingressEnabled || false}
          onChange={e => updateConfig('ingressEnabled', e.target.checked)}
          className="w-4 h-4"
        />
        <Label htmlFor="ingressEnabled" className="font-normal">
          Enable Ingress
        </Label>
      </div>
    </>
    ...
    <>
      ...
      <div className="flex items-center space-x-2">
        <input
          type="checkbox"
          id="apmEnabled"
          checked={config.apmEnabled !== false}
          onChange={e => updateConfig('apmEnabled', e.target.checked)}
          className="w-4 h-4"
        />
        <Label htmlFor="apmEnabled" className="font-normal">
          Enable APM (tracing)
        </Label>
      </div>
      <div className="flex items-center space-x-2">
        <input
          ...
          onChange={e => updateConfig('logsEnabled', e.target.checked)}
          className="w-4 h-4"
        />
        <Label htmlFor="logsEnabled" className="font-normal">
      ...
      <div className="flex items-center space-x-2">
        <input
          type="checkbox"
          id="processAgent"
          checked={config.processAgentEnabled || false}
          onChange={e => updateConfig('processAgentEnabled', e.target.checked)}
          className="w-4 h-4"
        />
        <Label htmlFor="processAgent" className="font-normal">
  ...
  const renderPrometheusConfig = () => (
    <>
      <div className="space-y-2">
        ...
        <Select
          value={config.scrapeInterval || '15s'}
          onValueChange={v => updateConfig('scrapeInterval', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.retentionTime || '15d'}
          onValueChange={v => updateConfig('retentionTime', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
  ...
  const renderRabbitMQConfig = () => (
    <>
      <div className="space-y-2">
        ...
        <Input
          placeholder="admin"
          value={config.defaultUser || 'admin'}
      ...
      <div className="space-y-2">
        ...
        <Input
          type="number"
          value={config.managementPort || 15672}
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          min={1}
          max={10}
          value={config.replicationFactor || 1}
      ...
      <div className="space-y-2">
        ...
        <Input
          type="number"
          value={config.retentionHours || 168}
  ...
  const renderResourceGroupConfig = () => (
    <>
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          Used to group and manage related Azure resources
        </p>
      </div>
      <div className="space-y-2">
        <Label>Location</Label>
        <Select
          value={config.location || 'westeurope'}
          onValueChange={v => updateConfig('location', v)}
        >
          <SelectTrigger>
            <SelectValue />
  ...
  const renderManagementGroupConfig = () => (
    <>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          Unique identifier — letters, digits, hyphens, underscores
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          value={
            Array.isArray(config.subscription_ids)
              ? config.subscription_ids.join(', ')
              : config.subscription_ids || ''
          }
          onChange={e =>
            updateConfig(
              'subscription_ids',
              e.target.value ? e.target.value.split(',').map((s: string) => s.trim()) : []
            )
          }
        />
        <p className="text-xs text-muted-foreground">
          Moves these subscriptions under this management group
        </p>
      </div>
    </>
  )
  ...
  const renderSubscriptionConfig = () => (
    <>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          Used for Terraform resource naming — no spaces
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          Set if managing an existing subscription; leave empty for new
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.workload || 'Production'}
          onValueChange={v => updateConfig('workload', v)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        />
        <p className="text-xs text-muted-foreground">
          EA enrollment account, MCA billing profile, or MPA
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={config.environment || '__none__'}
          onValueChange={v => updateConfig('environment', v === '__none__' ? undefined : v)}
        >
          <SelectTrigger>
  ...
  const renderConfigForm = () => {
    ...
    if (
      componentInfo.id.includes('management-group') ||
      componentInfo.id.includes('landing-zone')
    ) {
    ...
    if (
      componentInfo.id.includes('vm') ||
      componentInfo.id.includes('ec2') ||
      componentInfo.id.includes('compute')
    ) {
    ...
    if (
      componentInfo.id.includes('aks') ||
      componentInfo.id.includes('eks') ||
      componentInfo.id.includes('gke')
    ) {
    ...
    if (
      componentInfo.id.includes('app-service') ||
      componentInfo.id.includes('functions') ||
      componentInfo.id.includes('lambda')
    ) {
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <h2 className="font-semibold truncate">
              {String(node.data.label || componentInfo.name)}
            </h2>
                  ...
                  <>
                      ...
                      <div className="space-y-0.5">
                        <p className="text-sm font-medium">
                          ...
                          <code className="bg-muted px-1 rounded text-xs">
                            {componentInfo.terraform!.resource}
                          </code>
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Provider: {componentInfo.terraform!.provider} · file: resources.tf
                        </p>
                      </div>
                      <Button
                        size="sm"
                    ...
                    <div className="rounded-md border p-3 space-y-1">
                      ...
                      <p className="text-sm font-semibold">
                        ...
                        {componentInfo.estimatedCost.max > componentInfo.estimatedCost.min
                          ? ` – $${componentInfo.estimatedCost.max}`
                          : ''}
            ...
            {(generatorType === 'cicd' ||
              ...
              (() => {
                const previewNode = {
                  ...
                  data: {
                    ...node.data,
                    config: { ...(componentInfo.cicd?.defaultConfig || {}), ...config },
                  },
                } as any
                  ...
                  return (
                    <div className="flex flex-col items-center justify-center py-8 text-center gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        No preview available. Save your config and use Export to generate this file.
                      </p>
                    </div>
                  )
                return (
                  <>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        <p className="text-sm font-medium">
                          File:{' '}
                          <code className="bg-muted px-1 rounded text-xs">{output.filename}</code>
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Generator: {output.generatorType} · {output.language.toUpperCase()}
                        </p>
                      </div>
                      <Button
                        size="sm"
              ...
              <div className="flex flex-col items-center justify-center py-8 text-center gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground max-w-64">
                    ...
                    Terraform, CI/CD files, or any other code output. It will be mentioned in the
                    exported README only.
                  </p>
                </div>
                <div className="rounded-md border border-dashed p-3 w-full text-left space-y-1">
                  <p className="text-xs font-medium text-muted-foreground">
                    What generates code from your diagram:
                  </p>
                  <p className="text-xs text-muted-foreground">
                    • <strong className="text-foreground">AWS / Azure / GCP</strong> components →
                    Terraform HCL
                  </p>
                  <p className="text-xs text-muted-foreground">
                    •{' '}
                  ...
                  <p className="text-xs text-muted-foreground">
                    • <strong className="text-foreground">ArgoCD / Helm</strong> → Kubernetes
                    manifests
                  </p>
                  <p className="text-xs text-muted-foreground">
                    • <strong className="text-foreground">Datadog / Prometheus</strong> → Monitoring
                    config
                  </p>
                  <p className="text-xs text-muted-foreground">
                    • <strong className="text-foreground">RabbitMQ / Kafka / NATS</strong> →
                    docker-compose
                  </p>
                </div>
              </div>
