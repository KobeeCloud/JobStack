    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-amber-500 text-amber-950 py-2 px-4">
        <div className="container mx-auto flex items-center justify-center gap-2 text-sm font-medium">
          ...
          <span>
            🚧 This application is currently in <strong>beta testing</strong>. Please do not create
            real accounts or enter sensitive data.
          </span>
        </div>
      </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl text-muted-foreground mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                  AI-assisted visual editor for cloud architecture. Generate production-ready
                  Terraform code, validate connections, and estimate costs in real-time.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Link href="/demo">
                    <Button
                      size="lg"
                      variant="outline"
                      className="h-12 px-8 text-base backdrop-blur bg-background/50 hover:bg-muted/50 transition-all"
                    >
                      View Demo
                    </Button>
                  </Link>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                JobStack turns visual cloud architecture into the code and pipelines your team
                actually ships.
              </p>
            </div>
            <FeatureTabs />
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 tracking-tight">
                Everything You Need to Plan Infrastructure
              </h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                From visual design to production deployment
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Drag and drop 158+ components to design your infrastructure. Connect services
              ...
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Export production-ready Terraform code with detailed error messages and
                    validation warnings.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    See monthly costs as you build. Make informed decisions before deployment.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Built-in compliance checks for SOC2, HIPAA, GDPR, PCI-DSS, and AWS
              ...
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Validate connectivity, security groups, and high availability before deploying
                    to production.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Organizations, roles, and real-time collaborative editing with cloud sync.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Security groups, firewalls, WAF, and DDoS protection displayed as visual
              ...
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Export diagrams as PNG, SVG, JSON. Generate Terraform, CloudFormation, ARM
                    templates, and Pulumi TypeScript — all from your visual diagram.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="group hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 bg-background/50 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription className="text-sm mt-2 leading-relaxed">
                    Docker, Kubernetes, GitHub Actions, Jenkins, ArgoCD and more DevOps tools ready
                    to use.
                  </CardDescription>
                </CardHeader>
              </Card>
          ...
          <div className="container relative mx-auto px-4 z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto mb-12 leading-relaxed">
                JobStack diagrams generate CI/CD pipelines that post Terraform Plan output directly
                as PR comments. Review infra changes exactly the same way you review code.
              </p>
              <div className="grid sm:grid-cols-3 gap-6 text-left mb-12">
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur dark:bg-zinc-800/60 p-6 shadow-2xl transition-transform hover:-translate-y-1">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Commit your diagram — the pipeline triggers automatically
                  </p>
                </div>
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur dark:bg-zinc-800/60 p-6 shadow-2xl transition-transform hover:-translate-y-1">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Terraform Plan posted as a comment with inline diff highlighting
                  </p>
                </div>
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur dark:bg-zinc-800/60 p-6 shadow-2xl transition-transform hover:-translate-y-1">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    Protected environments firmly gate production applies
                  </p>
                </div>
              </div>
              <Link href="/register">
                <Button
                  size="lg"
                  className="bg-white text-black hover:bg-zinc-200 h-12 px-8 text-base shadow-xl"
                >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Unlimited personal projects
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Terraform code generation
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Cost estimation
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> All cloud providers
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> AI Assistant
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Compliance scanner
                    </li>
                  </ul>
                  <Link href="/register">
              ...
              <Card className="border-primary shadow-lg relative">
                ...
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Everything in Free
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Organizations (up to 5 members)
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Real-time collaboration
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" /> Version history
                    </li>
                    <li className="flex items-center gap-2">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <Button className="w-full" variant="outline" asChild>
                    <a href="mailto:kuba.pospieszny@gmail.com?subject=JobStack%20Enterprise%20Inquiry">
                      Contact Sales
                    </a>
                  </Button>
                </CardContent>
        ...
        <section className="py-20 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join developers and DevOps teams using JobStack
            </p>
