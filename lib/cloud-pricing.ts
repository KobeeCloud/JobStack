...
export const AZURE_VM_SIZES: VMSize[] = [
  ...
  // GPU - NC Series
  {
    ...
    memory: 112,
    pricePerHour: 3.06,
    pricePerMonth: 2233.8,
    category: 'gpu',
  },
  {
    id: 'Standard_NC12s_v3',
    name: 'NC12s v3 (2x V100)',
    vcpus: 12,
    memory: 224,
    pricePerHour: 6.12,
    pricePerMonth: 4467.6,
    category: 'gpu',
  },
  {
    id: 'Standard_NC24s_v3',
    name: 'NC24s v3 (4x V100)',
    vcpus: 24,
    memory: 448,
    pricePerHour: 12.24,
    pricePerMonth: 8935.2,
    category: 'gpu',
  },
]
...
export const AWS_VM_SIZES: VMSize[] = [
  ...
  {
    id: 'p4d.24xlarge',
    name: 'p4d.24xlarge (8x A100)',
    vcpus: 96,
    memory: 1152,
    pricePerHour: 32.77,
    pricePerMonth: 23922.1,
    category: 'gpu',
  },
  {
    id: 'g4dn.xlarge',
    ...
    memory: 16,
    pricePerHour: 0.526,
    pricePerMonth: 383.98,
    category: 'gpu',
  },
  {
    id: 'g4dn.2xlarge',
    name: 'g4dn.2xlarge (T4)',
    vcpus: 8,
    memory: 32,
    pricePerHour: 0.752,
    pricePerMonth: 548.96,
    category: 'gpu',
  },
]
...
export const GCP_VM_SIZES: VMSize[] = [
  ...
  {
    id: 'a2-highgpu-1g',
    name: 'a2-highgpu-1g (A100)',
    vcpus: 12,
    memory: 85,
    pricePerHour: 3.67,
    pricePerMonth: 2679.1,
    category: 'gpu',
  },
  {
    id: 'a2-highgpu-2g',
    name: 'a2-highgpu-2g (2x A100)',
    vcpus: 24,
    memory: 170,
    pricePerHour: 7.35,
    pricePerMonth: 5365.5,
    category: 'gpu',
  },
  {
    id: 'a2-highgpu-4g',
    name: 'a2-highgpu-4g (4x A100)',
    vcpus: 48,
    memory: 340,
    pricePerHour: 14.69,
    pricePerMonth: 10723.7,
    category: 'gpu',
  },
]
...
export const AWS_STORAGE: StorageTier[] = [
  { id: 'gp2', name: 'General Purpose SSD (gp2)', type: 'ssd', pricePerGBMonth: 0.1, iops: 3000 },
  {
    id: 'gp3',
...
export function getOSImagesForProvider(provider: 'azure' | 'aws' | 'gcp'): OSImage[] {
  switch (provider) {
    case 'azure':
      return AZURE_OS_IMAGES
    case 'aws':
      return AWS_OS_IMAGES
    case 'gcp':
      return GCP_OS_IMAGES
    default:
      return []
  }
}
