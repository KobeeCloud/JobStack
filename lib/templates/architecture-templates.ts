    ...
    nodes: [
      {
        ...
        type: 'container',
        position: { x: 50, y: 50 },
        data: { label: 'VPC', componentId: 'aws-vpc' },
      ...
      },
      {
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'Public Subnet', componentId: 'aws-subnet' },
      ...
      },
      {
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'Private Subnet 1', componentId: 'aws-subnet' },
        style: { width: 250, height: 180 },
      },
      {
        id: 'private-subnet-2',
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'Private Subnet 2', componentId: 'aws-subnet' },
        style: { width: 250, height: 180 },
      },
      {
        id: 'alb',
        ...
        extent: 'parent',
        data: { label: 'Application LB', componentId: 'aws-alb' },
      },
      {
        id: 'ec2-1',
        type: 'custom',
        ...
        extent: 'parent',
        data: { label: 'Web Server 1', componentId: 'aws-ec2' },
      },
      {
        id: 'ec2-2',
        type: 'custom',
        ...
        extent: 'parent',
        data: { label: 'Web Server 2', componentId: 'aws-ec2' },
      },
      {
        id: 'rds',
        type: 'custom',
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'RDS PostgreSQL', componentId: 'aws-rds' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        data: { label: 'API Gateway', componentId: 'aws-api-gateway' },
      },
      {
        id: 'lambda',
        type: 'custom',
        position: { x: 300, y: 150 },
        data: { label: 'Lambda Function', componentId: 'aws-lambda' },
      },
      {
        id: 'dynamodb',
        type: 'custom',
        position: { x: 500, y: 150 },
        data: { label: 'DynamoDB', componentId: 'aws-dynamodb' },
      },
      {
        id: 's3',
        type: 'custom',
        position: { x: 300, y: 300 },
        data: { label: 'S3 Bucket', componentId: 'aws-s3' },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'EKS Cluster', componentId: 'aws-eks' },
      },
      {
        id: 'ecr',
        type: 'custom',
        position: { x: 50, y: 150 },
        data: { label: 'ECR Registry', componentId: 'aws-ecr' },
      },
      {
        id: 'alb',
        type: 'custom',
        position: { x: 50, y: 300 },
        data: { label: 'ALB Ingress', componentId: 'aws-alb' },
      },
      {
        id: 'rds',
        type: 'custom',
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'RDS', componentId: 'aws-rds' },
      },
      {
        id: 'elasticache',
        type: 'custom',
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'ElastiCache', componentId: 'aws-elasticache' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'container',
        position: { x: 50, y: 50 },
        data: { label: 'Virtual Network', componentId: 'azure-vnet' },
      ...
      },
      {
        ...
        parentId: 'vnet',
        extent: 'parent',
        data: { label: 'Web Subnet', componentId: 'azure-subnet' },
      ...
      },
      {
        ...
        parentId: 'vnet',
        extent: 'parent',
        data: { label: 'Data Subnet', componentId: 'azure-subnet' },
        style: { width: 250, height: 150 },
      },
      {
        id: 'appgw',
        ...
        parentId: 'vnet',
        extent: 'parent',
        data: { label: 'App Gateway', componentId: 'azure-app-gw' },
      },
      {
        id: 'vm1',
        type: 'custom',
        ...
        parentId: 'subnet-web',
        extent: 'parent',
        data: { label: 'Web VM 1', componentId: 'azure-vm' },
      },
      {
        id: 'vm2',
        type: 'custom',
        ...
        parentId: 'subnet-web',
        extent: 'parent',
        data: { label: 'Web VM 2', componentId: 'azure-vm' },
      },
      {
        id: 'sql',
        type: 'custom',
        ...
        parentId: 'subnet-db',
        extent: 'parent',
        data: { label: 'SQL Database', componentId: 'azure-sql' },
      },
      {
        id: 'redis',
        type: 'custom',
        ...
        parentId: 'subnet-db',
        extent: 'parent',
        data: { label: 'Redis Cache', componentId: 'azure-redis' },
      },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        parentId: 'vnet',
        extent: 'parent',
        data: { label: 'AKS Cluster', componentId: 'azure-aks' },
      },
      {
        id: 'acr',
        type: 'custom',
        position: { x: 50, y: 150 },
        data: { label: 'Container Registry', componentId: 'azure-acr' },
      },
      {
        id: 'keyvault',
        type: 'custom',
        position: { x: 50, y: 300 },
        data: { label: 'Key Vault', componentId: 'azure-keyvault' },
      },
      {
        id: 'cosmosdb',
        type: 'custom',
        position: { x: 600, y: 150 },
        data: { label: 'Cosmos DB', componentId: 'azure-cosmosdb' },
      },
      {
        id: 'appinsights',
        type: 'custom',
        position: { x: 600, y: 300 },
        data: { label: 'App Insights', componentId: 'azure-app-insights' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        data: { label: 'Cloud Load Balancing', componentId: 'gcp-load-balancer' },
      },
      {
        id: 'run',
        type: 'custom',
        position: { x: 300, y: 100 },
        data: { label: 'Cloud Run', componentId: 'gcp-cloud-run' },
      },
      {
        id: 'functions',
        type: 'custom',
        position: { x: 300, y: 250 },
        data: { label: 'Cloud Functions', componentId: 'gcp-cloud-functions' },
      },
      {
        id: 'firestore',
        type: 'custom',
        position: { x: 500, y: 175 },
        data: { label: 'Firestore', componentId: 'gcp-firestore' },
      },
      {
        id: 'storage',
        type: 'custom',
        position: { x: 500, y: 325 },
        data: { label: 'Cloud Storage', componentId: 'gcp-storage' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'container',
        position: { x: 50, y: 50 },
        data: { label: 'VPC Network', componentId: 'gcp-vpc' },
      ...
      },
      {
        ...
        parentId: 'vpc',
        extent: 'parent',
        data: { label: 'GKE Cluster', componentId: 'gcp-gke' },
      },
      {
        id: 'vertexai',
        type: 'custom',
        position: { x: 500, y: 100 },
        data: { label: 'Vertex AI', componentId: 'gcp-vertex-ai' },
      },
      {
        id: 'bigquery',
        type: 'custom',
        position: { x: 500, y: 250 },
        data: { label: 'BigQuery', componentId: 'gcp-bigquery' },
      },
      {
        id: 'storage',
        type: 'custom',
    ...
    nodes: [
      {
        ...
        type: 'custom',
        position: { x: 100, y: 150 },
        data: { label: 'GitHub', componentId: 'github' },
      },
      {
        id: 'actions',
        type: 'custom',
        position: { x: 250, y: 150 },
        data: { label: 'GitHub Actions', componentId: 'github-actions' },
      },
      {
        id: 'ecr',
        type: 'custom',
        position: { x: 400, y: 100 },
        data: { label: 'ECR', componentId: 'aws-ecr' },
      },
      {
        id: 'ecs',
        type: 'custom',
        position: { x: 550, y: 150 },
        data: { label: 'ECS Fargate', componentId: 'aws-ecs' },
      },
      {
        id: 's3',
        type: 'custom',
        position: { x: 400, y: 250 },
        data: { label: 'S3 Artifacts', componentId: 'aws-s3' },
      },
    ],
    edges: [
