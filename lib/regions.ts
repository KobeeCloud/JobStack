...
export const AZURE_REGIONS: CloudRegion[] = [
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 36.6681, lng: -78.3889 },
    paired: 'centralus',
  },
  {
    id: 'westus',
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 37.783, lng: -122.417 },
    paired: 'eastus',
  },
  {
    id: 'westus2',
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 47.233, lng: -119.852 },
    paired: 'westcentralus',
  },
  {
    id: 'westus3',
    name: 'West US 3',
    displayName: 'West US 3 (Arizona)',
    provider: 'azure',
    geography: 'United States',
    continent: 'north-america',
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 41.5908, lng: -93.6208 },
    paired: 'eastus2',
  },
  {
    id: 'northcentralus',
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 29.4167, lng: -98.5 },
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 40.89, lng: -110.234 },
    paired: 'westus2',
  },
  {
    id: 'canadacentral',
  ...
  },
  {
    id: 'canadaeast',
    name: 'Canada East',
    displayName: 'Canada East (Quebec)',
    provider: 'azure',
    geography: 'Canada',
    continent: 'north-america',
    coordinates: { lat: 46.817, lng: -71.217 },
  ...
  // Europe
  {
    ...
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 53.3478, lng: -6.2597 },
    paired: 'westeurope',
  },
  {
    id: 'westeurope',
    ...
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 52.3667, lng: 4.9 },
    paired: 'northeurope',
  },
  {
    id: 'uksouth',
  ...
  },
  {
    ...
    geography: 'United Kingdom',
    continent: 'europe',
    coordinates: { lat: 51.481, lng: -3.179 },
    paired: 'uksouth',
  },
  {
    id: 'francecentral',
    ...
    geography: 'France',
    continent: 'europe',
    coordinates: { lat: 46.3772, lng: 2.373 },
    paired: 'francesouth',
  },
  {
    id: 'francesouth',
    ...
    geography: 'France',
    continent: 'europe',
    coordinates: { lat: 43.8345, lng: 2.1972 },
  ...
  },
  {
    ...
    continent: 'europe',
    coordinates: { lat: 47.451542, lng: 8.564572 },
    paired: 'switzerlandwest',
  },
  {
    id: 'norwayeast',
    name: 'Norway East',
    displayName: 'Norway East (Oslo)',
    provider: 'azure',
    geography: 'Norway',
    continent: 'europe',
    coordinates: { lat: 59.913868, lng: 10.752245 },
    paired: 'norwaywest',
  },
  {
    id: 'polandcentral',
  ...
  // Asia Pacific
  {
    ...
    coordinates: { lat: 22.267, lng: 114.188 },
  ...
  },
  {
    ...
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 1.283, lng: 103.833 },
    paired: 'eastasia',
  },
  {
    id: 'japaneast',
  ...
  },
  {
    ...
    geography: 'Japan',
    continent: 'asia-pacific',
    coordinates: { lat: 34.6939, lng: 135.5022 },
    paired: 'japaneast',
  },
  {
    id: 'australiaeast',
    ...
    geography: 'Australia',
    continent: 'asia-pacific',
    coordinates: { lat: -33.86, lng: 151.2094 },
  ...
  },
  {
    ...
    geography: 'India',
    continent: 'asia-pacific',
    coordinates: { lat: 12.9822, lng: 80.1636 },
    paired: 'centralindia',
  },
  {
    id: 'koreacentral',
  ...
  // Middle East & Africa
  {
    ...
    coordinates: { lat: 25.266666, lng: 55.316666 },
    paired: 'uaecentral',
  },
  {
    id: 'southafricanorth',
    name: 'South Africa North',
    displayName: 'South Africa North (Johannesburg)',
    provider: 'azure',
    geography: 'South Africa',
    continent: 'africa',
    coordinates: { lat: -26.198, lng: 28.03 },
    paired: 'southafricawest',
  },
  {
    id: 'qatarcentral',
    name: 'Qatar Central',
    displayName: 'Qatar Central (Doha)',
    provider: 'azure',
    geography: 'Qatar',
    continent: 'middle-east',
  ...
  // South America
  {
    id: 'brazilsouth',
    name: 'Brazil South',
    displayName: 'Brazil South (São Paulo)',
    provider: 'azure',
    geography: 'Brazil',
...
export const AWS_REGIONS: CloudRegion[] = [
  // North America
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 38.9519, lng: -77.448 },
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 40.4167, lng: -82.9167 },
  ...
  },
  {
    ...
    zones: ['il-central-1a', 'il-central-1b', 'il-central-1c'],
  },
...
export const GCP_REGIONS: CloudRegion[] = [
  ...
  },
  {
    ...
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 33.196, lng: -80.0131 },
    zones: ['us-east1-b', 'us-east1-c', 'us-east1-d'],
  },
  {
    id: 'us-east4',
    name: 'Northern Virginia',
    displayName: 'Northern Virginia (us-east4)',
    provider: 'gcp',
    geography: 'United States',
    continent: 'north-america',
    coordinates: { lat: 38.7223, lng: -77.019 },
    zones: ['us-east4-a', 'us-east4-b', 'us-east4-c'],
  },
  {
    id: 'us-east5',
    name: 'Columbus',
    displayName: 'Columbus (us-east5)',
    provider: 'gcp',
    geography: 'United States',
    continent: 'north-america',
  ...
  },
  {
    id: 'us-west2',
    name: 'Los Angeles',
    displayName: 'Los Angeles (us-west2)',
    provider: 'gcp',
    geography: 'United States',
    continent: 'north-america',
  ...
  },
  {
    id: 'us-west3',
    name: 'Salt Lake City',
    displayName: 'Salt Lake City (us-west3)',
    provider: 'gcp',
    geography: 'United States',
    continent: 'north-america',
  ...
  },
  {
    id: 'us-west4',
    name: 'Las Vegas',
    displayName: 'Las Vegas (us-west4)',
    provider: 'gcp',
    geography: 'United States',
    continent: 'north-america',
  ...
  },
  {
    ...
    name: 'Montréal',
    displayName: 'Montréal (northamerica-northeast1)',
    provider: 'gcp',
    geography: 'Canada',
    continent: 'north-america',
    coordinates: { lat: 45.5017, lng: -73.5673 },
  ...
  },
  {
    ...
    name: 'Toronto',
    displayName: 'Toronto (northamerica-northeast2)',
    provider: 'gcp',
    geography: 'Canada',
    continent: 'north-america',
  ...
  // Europe
  {
    ...
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 50.4501, lng: 3.5547 },
    zones: ['europe-west1-b', 'europe-west1-c', 'europe-west1-d'],
  },
  {
    id: 'europe-west2',
    name: 'London',
    displayName: 'London (europe-west2)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 51.5074, lng: -0.1278 },
  ...
  },
  {
    id: 'europe-west3',
    name: 'Frankfurt',
    displayName: 'Frankfurt (europe-west3)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 50.1109, lng: 8.6821 },
  ...
  },
  {
    ...
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 53.4386, lng: 6.8355 },
    zones: ['europe-west4-a', 'europe-west4-b', 'europe-west4-c'],
  },
  {
    id: 'europe-west6',
    name: 'Zurich',
    displayName: 'Zurich (europe-west6)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 47.3769, lng: 8.5417 },
  ...
  },
  {
    id: 'europe-west8',
    name: 'Milan',
    displayName: 'Milan (europe-west8)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 45.4642, lng: 9.19 },
  ...
  },
  {
    id: 'europe-west9',
    name: 'Paris',
    displayName: 'Paris (europe-west9)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 48.8566, lng: 2.3522 },
  ...
  },
  {
    id: 'europe-north1',
    name: 'Finland',
    displayName: 'Finland (europe-north1)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
    coordinates: { lat: 60.5693, lng: 27.1878 },
    zones: ['europe-north1-a', 'europe-north1-b', 'europe-north1-c'],
  },
  {
    id: 'europe-central2',
    name: 'Warsaw',
    displayName: 'Warsaw (europe-central2)',
    provider: 'gcp',
    geography: 'Europe',
    continent: 'europe',
  ...
  // Asia Pacific
  {
    ...
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 24.0717, lng: 120.5624 },
    zones: ['asia-east1-a', 'asia-east1-b', 'asia-east1-c'],
  },
  {
    id: 'asia-east2',
    name: 'Hong Kong',
    displayName: 'Hong Kong (asia-east2)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
  ...
  },
  {
    id: 'asia-northeast2',
    name: 'Osaka',
    displayName: 'Osaka (asia-northeast2)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 34.6937, lng: 135.5023 },
  ...
  },
  {
    id: 'asia-northeast3',
    name: 'Seoul',
    displayName: 'Seoul (asia-northeast3)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 37.5665, lng: 126.978 },
  ...
  },
  {
    id: 'asia-south1',
    name: 'Mumbai',
    displayName: 'Mumbai (asia-south1)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 19.076, lng: 72.8777 },
  ...
  },
  {
    id: 'asia-southeast1',
    name: 'Singapore',
    displayName: 'Singapore (asia-southeast1)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: 1.3521, lng: 103.8198 },
  ...
  },
  {
    id: 'asia-southeast2',
    name: 'Jakarta',
    displayName: 'Jakarta (asia-southeast2)',
    provider: 'gcp',
    geography: 'Asia Pacific',
    continent: 'asia-pacific',
    coordinates: { lat: -6.2088, lng: 106.8456 },
  ...
  },
  {
    ...
    name: 'Sydney',
    displayName: 'Sydney (australia-southeast1)',
    provider: 'gcp',
    geography: 'Australia',
    continent: 'asia-pacific',
    coordinates: { lat: -33.8688, lng: 151.2093 },
  ...
  },
  {
    ...
    name: 'Melbourne',
    displayName: 'Melbourne (australia-southeast2)',
    provider: 'gcp',
    geography: 'Australia',
    continent: 'asia-pacific',
    coordinates: { lat: -37.8136, lng: 144.9631 },
  ...
  // Middle East
  {
    id: 'me-west1',
    name: 'Tel Aviv',
    displayName: 'Tel Aviv (me-west1)',
    provider: 'gcp',
    geography: 'Middle East',
    continent: 'middle-east',
    coordinates: { lat: 32.0853, lng: 34.7818 },
    zones: ['me-west1-a', 'me-west1-b', 'me-west1-c'],
  },
  {
    id: 'me-central1',
    name: 'Doha',
    displayName: 'Doha (me-central1)',
    provider: 'gcp',
    geography: 'Middle East',
    continent: 'middle-east',
    coordinates: { lat: 25.2854, lng: 51.531 },
  ...
  // South America
  {
    ...
    name: 'São Paulo',
    displayName: 'São Paulo (southamerica-east1)',
    provider: 'gcp',
    geography: 'South America',
    continent: 'south-america',
    coordinates: { lat: -23.5505, lng: -46.6333 },
  ...
  },
  {
    ...
    name: 'Santiago',
    displayName: 'Santiago (southamerica-west1)',
    provider: 'gcp',
    geography: 'South America',
    continent: 'south-america',
  ...
  // Africa
  {
    id: 'africa-south1',
    name: 'Johannesburg',
    displayName: 'Johannesburg (africa-south1)',
    provider: 'gcp',
    geography: 'Africa',
    continent: 'africa',
    coordinates: { lat: -26.2041, lng: 28.0473 },
    zones: ['africa-south1-a', 'africa-south1-b', 'africa-south1-c'],
  },
]
...
export function estimateLatency(region1Id: string, region2Id: string): number {
  ...
  const a =
    Math.sin(dLat / 2) ** 2 +
    Math.cos(toRad(r1.coordinates.lat)) *
      Math.cos(toRad(r2.coordinates.lat)) *
      Math.sin(dLng / 2) ** 2
