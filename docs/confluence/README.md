# JobStack — Dokumentacja Confluence

Dokumentacja do importu w Atlassian Confluence.
Każdy plik `.html` to osobna strona Confluence.
...
1. **Space** → **Content Tools** → **Import**
2. Wybierz format **HTML**
3. Wgraj pliki `.html` pojedynczo lub stwórz page hierarchy ręcznie
4. Alternatywnie: skopiuj zawartość każdego pliku i wklej w edytorze Confluence (tryb source/markup)

## Wersja dokumentacji

- **Projekt:** JobStack v2.0.0
- **Data:** 8 lutego 2026
- **Autor:** Kuba Pośpieszny / KobeeCloud
